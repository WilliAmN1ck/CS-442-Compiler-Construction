...
/* ValidMessageSpan   Checks if the given span is already in the list of
                      messages. Returns true if the span does not overlap
                      any of the messages currently in the list. Returns false
                      otherwise.
*/
bool ValidMessageSpan(struct Span span);
